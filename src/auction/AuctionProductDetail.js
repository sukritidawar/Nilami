        ...
        >
          ...
          >
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <Typography variant="h3" style={{ fontFamily: 'serif', textTransform: 'uppercase', textAlign: 'center' }}>
              ...
              <>{timeUp ? <>
                <Grid item xs={12} style={{ textAlign: 'center', alignContent: 'center' }}>
                  <Typography variant='h4' style={{ color: 'red' }}>Closed</Typography>
                </Grid>
                <Grid item xs={12} style={{ textAlign: 'center', alignContent: 'center' }}>
                  ...
                  <>
                    {(() => {
                      if (userAuth.user_id == auctionDetails.auctioneerUserName || userAuth.user_id == auctionDetails.winner_user_id) {
                        return (
                          <Link to={`/feed/${id}/chat`} state={auctionDetails} style={{ textDecoration: 'none' }}>
                            <Button variant='contained' style={{ backgroundColor: "rgb(38,70,83)" }}>CHAT</Button></Link>
                        )
                      }
                    })()}</>
                  : <h6></h6>}
              </> : (<>
                <Grid item xs={12} md={6} style={{ textAlign: 'center', alignContent: 'center' }}>
                ...
                <Grid item xs={12} style={{ justifyContent: 'center', textAlign: 'center', aligncontent: 'center', marginTop: 2 }}>
                  {/* remove this exclamation mark */}
                  {isRegistered ?
                    <>
                      {hasStarted ? <>
                        <Typography style={{ color: 'rgb(42,157,143)' }}>You have registered for the auction. Please proceed with bidding.</Typography>
                        ...
                        :
                        <Typography style={{ color: 'rgb(42,157,143)' }}>You have registered for the auction.</Typography>
                      }
                    </>
                    :
